...
pub use domain::{
    ...
    SecretsConfigPatch, SecurityProfile, SnapshotSpec, Socks5Credentials, SshConfig,
    SshConfigPatch, SshGrant, StatVirtualization, TlsConfig, TlsConfigPatch, TokenBucketConfig,
